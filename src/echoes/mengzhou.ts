...
export const LAMP_STACKS = new Buff({
  ...
  convertStats: () => { if (casting(Cast.Outro)) revokeSelf(LAMP_STACKS); },
});
...
export const CALAMITY_EFFIGY_STRAIN = new Buff({
  ...
  convertStats: () => { if (casting(Cast.Outro)) revokeSelf(CALAMITY_EFFIGY_STRAIN); },
});
...
export const HEART_OF_EVILS_PURGE_BUFF = new Buff({
  ...
  convertStats: () => { if (casting(Cast.Outro)) revokeSelf(HEART_OF_EVILS_PURGE_BUFF); },
});
