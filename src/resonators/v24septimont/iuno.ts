...
import {
  ...
  Scaling, applyCurrent, applyTeam, currentAction, casting, queueOutro, revokeSelf, addStat, frozenStacks, lostOnSwap,
  applied,
} from "../../engine/kit.js";
...
const IUNO = new Resonator({
  ...
  updateDebuffs: () => { if (SHIELDING.has(currentAction())) applyCurrent(SHIELD, 1); },
