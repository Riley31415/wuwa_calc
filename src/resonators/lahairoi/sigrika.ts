...
import {
  ...
  applySelf, applyTeam, isHeld, stacksOfTeam, removeStack, revoke, casting, currentAction, addStat, stacks, getStat,
  queue, lostOnSwap,
} from "../../kit.js";
...
function erSteps(): number { return Math.floor(getStat(Stat.Er)); }
