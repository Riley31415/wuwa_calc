 ...
 *
 * Numbers from nanoka.cc (character 1607, https://ww.nanoka.cc/character/1607, weapon 21050056, echo 6000082); cross-checked
...
import { LORELEI, MIDNIGHT_VEIL_2PC, MIDNIGHT_VEIL_5PC } from "../echoes/rinascita.js";
...
/** Her echoes: Heron mainslot (echoes/jinzhou.js), full 5pc Moonlit Clouds (echoes/jinzhou.js, both its 2pc
 *  and 5pc bonuses, same as Sanhua's own loadout) — Lorelei and Midnight Veil (both her own,
 *  echoes/rinascita.js) are her alternate build; Whispers of Sirens (her own signature) lives in
 *  weapons/rectifier.js. 43311 crit-rate build; she scales off ATK like everything else here. */
...
const BA1 = cantaAction("Basic: Illusion Collapse 1", { node: Node.Normal, cast: Cast.Basic, type: DamageType.Basic, mv: 79.53, energy: 100, concerto: 320 });
const BA2 = cantaAction("Basic: Illusion Collapse 2", { node: Node.Normal, cast: Cast.Basic, type: DamageType.Basic, mv: 145.76, energy: 184, concerto: 368 });
const BA3 = cantaAction("Basic: Illusion Collapse 3", { node: Node.Normal, cast: Cast.Basic, type: DamageType.Basic, mv: 145.14, energy: 184, concerto: 366, forte1: 1 });
const MA = cantaAction("Basic: Illusion Collapse (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: DamageType.Basic, mv: 104.98, energy: 132, concerto: 264 });
const HA = cantaAction("Heavy 1: Illusion Collapse", { node: Node.Normal, cast: Cast.Heavy, type: DamageType.Heavy, mv: 114.36, energy: 144, concerto: 288 });
const DC = cantaAction("Basic: Illusion Collapse (Dodge Counter)", { node: Node.Normal, cast: Cast.DodgeCounter, type: DamageType.Heavy, mv: 212.04, energy: 265, concerto: 531 });

export const BA123 = new Chain("Basic: Illusion Collapse 123", [BA1, BA2, BA3]);
...
const EHA = cantaAction("Heavy 2: Delusive Dive", {
  node: Node.Normal, cast: Cast.Heavy, type: DamageType.Heavy, mv: 106.1, energy: 168, concerto: 334,
  priority: PRIORITY.UPDATE_BUFFS,
  apply(ctx) { ctx.grantSelf(MIRAGE); },
});
export const FBA1 = cantaAction("Basic: Phantom Sting 1", { node: Node.Forte, cast: Cast.Basic, type: DamageType.Basic, mv: 105.99, energy: 135, concerto: 267, forte1: -1, forte2: 1 });
export const FBA2 = cantaAction("Basic: Phantom Sting 2", { node: Node.Forte, cast: Cast.Basic, type: DamageType.Basic, mv: 125.86, energy: 160, concerto: 318, forte1: -1, forte2: 1 });
export const FBA3 = cantaAction("Basic: Phantom Sting 3", { node: Node.Forte, cast: Cast.Basic, type: DamageType.Basic, type2: Type2.Coordinated, mv: 258.48, energy: 328, concerto: 652, forte1: -1, forte2: 1 });
const FMA = cantaAction("Basic: Abysmal Vortex (Mid-Air)", { node: Node.Forte, cast: Cast.Basic, type: DamageType.Basic, mv: 104.98, energy: 132, concerto: 264, forte1: -1, forte2: 1 });
// no confident wuwalab match for this one (its listed Phantom Sting dodge counter shares Stage
// 1's own MV, not this) — left as its own descriptive name rather than guessing
...
export const FBA123 = new Chain("Basic: Phantom Sting 123", [FBA1, FBA2, FBA3]);
...
const Skill = cantaAction("Skill 1: Graceful Step", { node: Node.Skill, cast: Cast.Skill, type: DamageType.Skill, mv: 147.2, energy: 156, concerto: 1000, forte1: 1 });
const ESkill = cantaAction("Skill 2: Flickering Reverie", {
  node: Node.Skill, cast: Cast.Skill, cast2: Cast.Echo, type: DamageType.Skill, mv: 196.23, energy: 165, concerto: 1000,
  priority: PRIORITY.UPDATE_BUFFS,
...
const FSkill = cantaAction("Forte: Perception Drain", { node: Node.Forte, cast: Cast.Skill, cast2: Cast.Echo, type: DamageType.Basic, mv: 1335.98, energy: 2110, concerto: 1200, forte2: -3 });
...
const Liberation = cantaAction("Liberation: Beneath the Sea", {
  node: Node.Liberation, cast: Cast.Liberation, cast2: Cast.Echo, type: DamageType.Basic, mv: 376, energy: -12500, concerto: 2000, forte1: 3,
});
 ...
 *  hence inactive. */
export const ACTION_DIFFUSION = cantaAction("Dreamweaver x21", {
...
const Intro = cantaAction("Intro: Ripple", {
  node: Node.Intro, cast: Cast.Intro, type: DamageType.Intro, mv: 169, energy: 316, concerto: 1000, forte1: 1,
  priority: PRIORITY.UPDATE_BUFFS,
...
const EIntro = cantaAction("Intro 2: Tidal Surge", {
  node: Node.Intro, cast: Cast.Intro, type: DamageType.Intro, mv: 169, energy: 335, concerto: 1000, forte1: 1,
});
