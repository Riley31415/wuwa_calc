...
const BA1 = galbrenaAction("Basic: Slayer's Trigger 1", { node: Node.Normal, cast: Cast.Basic, type: Type1.Heavy, mv: 59.18, energy: 83, concerto: 116, offtune: 2646, forte1: 7.41 });
const BA2 = galbrenaAction("Basic: Slayer's Trigger 2", { node: Node.Normal, cast: Cast.Basic, type: Type1.Heavy, mv: 131.53, energy: 185, concerto: 259, offtune: 5880, forte1: 18.52 });   // 26.31+26.31+78.91
const BA3 = galbrenaAction("Basic: Slayer's Trigger 3", { node: Node.Normal, cast: Cast.Basic, type: Type1.Heavy, mv: 142.98, energy: 200, concerto: 280, offtune: 6394, forte1: 18.52 });   // 28.60+28.60+42.89+42.89
const BA4 = galbrenaAction("Basic: Slayer's Trigger 4", {
  node: Node.Normal, cast: Cast.Basic, type: Type1.Echo, mv: 177.86,
...
const DC = galbrenaAction("Basic: Blood for Blood (Dodge Counter)", { node: Node.Normal, cast: Cast.DodgeCounter, type: Type1.Heavy, mv: 205.24 });   // 41.05x2+61.57x2
const MA = galbrenaAction("Basic: Ashfall Barrage (Plunge)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Heavy, mv: 143.15, energy: 200, concerto: 280, offtune: 6400 });
...
const HA1 = galbrenaAction("Heavy: Volley of Death 1", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 106.60, energy: 150, concerto: 210, offtune: 4764, forte1: 7.41 });   // 53.30x2
const HA2 = galbrenaAction("Heavy: Volley of Death 2", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 69.18, energy: 98, concerto: 136, offtune: 3094, forte1: 25.93 });   // 34.59x2
const HA3 = galbrenaAction("Heavy: Volley of Death 3", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Echo, mv: 167.70, energy: 237, concerto: 329, offtune: 7499, forte1: 18.52 });   // 16.77x3+117.39
...
const Encroach = galbrenaAction("Skill: Encroach", {
  node: Node.Skill, cast: Cast.Skill, type: Type1.Heavy, mv: 35.78,   // 10.74+25.04
...
const AscentOfMalice = galbrenaAction("Skill: Ascent of Malice", {
  node: Node.Skill, cast: Cast.Skill, type: Type1.Heavy, mv: 103.14,   // 51.57x2
...
const SeraphicExecution1 = galbrenaAction("Basic: Seraphic Execution 1", { node: Node.Forte, cast: Cast.Basic, type: Type1.Heavy, mv: 58.99, energy: 100, concerto: 554, offtune: 2374 });
const SeraphicExecution2 = galbrenaAction("Basic: Seraphic Execution 2", { node: Node.Forte, cast: Cast.Basic, type: Type1.Heavy, mv: 139.19, energy: 200, concerto: 695, offtune: 5600 });   // 27.84x2+83.51
const SeraphicExecution3 = galbrenaAction("Basic: Seraphic Execution 3", { node: Node.Forte, cast: Cast.Basic, type: Type1.Heavy, mv: 243.17, energy: 334, concerto: 879, offtune: 9786 });   // 24.32x3+170.21
const SeraphicExecution4 = galbrenaAction("Basic: Seraphic Execution 4", {
  node: Node.Forte, cast: Cast.Basic, type: Type1.Echo, mv: 181.47,   // 18.15x3+127.02
  energy: 256, concerto: 770, offtune: 7305,
  priority: PRIORITY.BUFF_STATS, apply(ctx) { ctx.grantSelf(BURNING_DRIVE); },
});
const SeraphicExecution5 = galbrenaAction("Basic: Seraphic Execution 5", { node: Node.Forte, cast: Cast.Basic, type: Type1.Echo, mv: 224.27, energy: 308, concerto: 846, offtune: 9025 });   // 67.28+156.99
...
const FlamewingVerdict1 = galbrenaAction("Heavy: Flamewing Verdict 1", { node: Node.Forte, cast: Cast.Heavy, type: Type1.Heavy, mv: 118.44, energy: 174, concerto: 660, offtune: 4766 });   // 59.22x2
const FlamewingVerdict2 = galbrenaAction("Heavy: Flamewing Verdict 2", { node: Node.Forte, cast: Cast.Heavy, type: Type1.Heavy, mv: 76.70, energy: 122, concerto: 586, offtune: 3086 });   // 38.35x2
const FlamewingVerdict3 = galbrenaAction("Heavy: Flamewing Verdict 3", { node: Node.Forte, cast: Cast.Heavy, type: Type1.Echo, mv: 176.84, energy: 249, concerto: 764, offtune: 7117 });   // 17.69x3+123.77
...
const Ravage = galbrenaAction("Skill: Ravage", {
  node: Node.Forte, cast: Cast.Skill, type: Type1.Heavy, mv: 35.78,   // 10.74+25.04
...
const Liberation = galbrenaAction("Liberation: Hellfire Absolution", {
  node: Node.Liberation, cast: Cast.Liberation, type: Type1.Echo, mv: 1109.04,   // 110.90+90.74x11
...
const Intro = galbrenaAction("Intro: Hellflare Overload", {
  node: Node.Intro, cast: Cast.Intro, type: Type1.Intro, mv: 94.12,
  energy: 1000, concerto: 1000, offtune: 4208, forte1: 11.11,
  priority: PRIORITY.BUFF_STATS, apply(ctx) { ctx.grantSelf(BURNING_DRIVE); },
});
const Outro = galbrenaAction("Outro: Ashen Pursuit", {
  cast: Cast.Outro, type: Type1.Outro, mv: 795, concerto: -10000, active: false,   // 79.50x3+556.50
});
