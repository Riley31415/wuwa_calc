...
import {
  ...
  applySelf, currentAction, casting, revoke, addStat, stacks, removeStack, queueOn, queueOutro,
} from "../../kit.js";
...
export const BA1 = xlyAction("Basic - Probe 1", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 33.11 * 2, energy: 0.84, concerto: 1.68, offtune: 2664, forte1: 8 });
export const BA2 = xlyAction("Basic - Probe 2", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 99.61, energy: 1.26, concerto: 2.51, offtune: 4008, forte1: 14 });
...
export const BA4 = xlyAction("Basic - Probe 4", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 53.05 * 2 + 26.53, energy: 1.68, concerto: 3.35, offtune: 5338, forte1: 18 });
...
export const HA = xlyAction("Heavy - Probe", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 82.81 * 2, energy: 2.10, concerto: 4.18, offtune: 6664, forte1: 18 });
export const MA = xlyAction("Basic - Probe (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 123.27, energy: 0.52, concerto: 1.00, offtune: 4960, forte1: 13 });
export const DC = xlyAction("Basic - Probe (Dodge Counter)", { node: Node.Normal, cast: Cast.DodgeCounter, type: Type1.Basic, mv: 238.58, energy: 2.75, concerto: 12.50, offtune: 4000, forte1: 26 });

export const Skill = xlyAction("Skill - Deduction", { node: Node.Skill, cast: Cast.Skill, type: Type1.Skill, mv: 198.81, energy: 6.25, concerto: 7, offtune: 4000, forte1: 40 });
...
export const UForte = xlyAction("Forte Skill - Law of Reigns", { node: Node.Forte, cast: Cast.Skill, type: Type1.Liberation, mv: 95.73 * 4 + 255.28, energy: 4.78, concerto: 10, offtune: 45600, forte2: -5 });
/** Revamp, the mid-air follow-up to Decipher/Divergence — considered Liberation DMG. */
export const FBA = xlyAction("Basic - Revamp (Mid-Air)", { node: Node.Forte, cast: Cast.Basic, type: Type1.Liberation, mv: 21.87 * 4 + 65.61 * 2, energy: 2.78, concerto: 5, offtune: 8800, forte2: 3 });
...
export const ACTION_OUTRO_COORD = xlyAction("Outro - Chain Rule (Laser)", { type: Type1.Outro, mv: 237.63, active: false });
...
export const XLY_LOADOUT = new Loadout(
  ...
  [VERITYS_HANDLE, ABYSS_SURGES, NEW_STD_GAUNTLET, IUNO_SIG],
