...
// Creation's Zenith (spends both Painter's Delight stacks, never tracked directly)
...
export const ZZ_INHERENT_1 = new Inherent({
  name: "Zhezhi: Calligrapher's Touch",
  update: () => { const a = currentAction(); if (a === FSkill || a === FSkill3) applySelf(CALLIGRAPHERS_TOUCH, 1); },
});
...
export const ZZ_FLOURISH = new Buff({
...
export const ZZ_INHERENT_2 = new Inherent({
  name: "Zhezhi: Flourish",
  update: () => {
...
export const ZHEZHI_TALENTS = new Talent({
  name: "Zhezhi: Talents",
