...
export const BA1 = changliAction("Basic - Blazing Enlightenment 1", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 58.98, energy: 0.88, concerto: 1.76 });
export const BA2 = changliAction("Basic - Blazing Enlightenment 2", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 70.98, energy: 1.06, concerto: 2.10 });
export const BA3 = changliAction("Basic - Blazing Enlightenment 3", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 109.35, energy: 1.62, concerto: 3.24 });
export const BA4 = changliAction("Basic - Blazing Enlightenment 4", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 169.02, energy: 2.51, concerto: 5.02 });
export const DC = changliAction("Basic - Blazing Enlightenment 3 (Dodge Counter)", { node: Node.Normal, cast: Cast.DodgeCounter, type: Type1.Basic, mv: 247.92, energy: 3.12, concerto: 6.24 });
export const HA = changliAction("Heavy - Blazing Enlightenment", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 124.24, energy: 1.85, concerto: 3.69 });

// --- mid-air basics, mid-air heavy — the same combo, airborne. Stage 4 also opens True Sight.
export const MA1 = changliAction("Basic - Blazing Enlightenment 1 (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 61.35, energy: 0.91, concerto: 1.82 });
export const MA2 = changliAction("Basic - Blazing Enlightenment 2 (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 101.74, energy: 1.52, concerto: 3.02 });
export const MA3 = changliAction("Basic - Blazing Enlightenment 3 (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 132.00, energy: 1.98, concerto: 3.93 });
export const MA4 = changliAction("Basic - Blazing Enlightenment 4 (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 126.75, energy: 1.89, concerto: 3.77 });
export const MHA = changliAction("Heavy - Blazing Enlightenment (Mid-Air)", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 123.27, energy: 1.55, concerto: 1.00 });
...
export const SBA = changliAction("True Sight - Conquest", { node: Node.Skill, cast: Cast.Basic, type: Type1.Skill, mv: 294.73, energy: 4.20, concerto: 7.00, forte1: 1 });
export const SMA = changliAction("True Sight - Charge", { node: Node.Skill, cast: Cast.Basic, type: Type1.Skill, mv: 181.70, energy: 2.57, concerto: 6.00, forte1: 1 });
...
export const Skill = changliAction("Skill - Tripartite Flames", { node: Node.Skill, cast: Cast.Skill, type: Type1.Skill, mv: 409.40, energy: 8.00, concerto: 14.00 });
...
export const FlamingSacrifice = changliAction("Forte Heavy - Flaming Sacrifice", { node: Node.Forte, cast: Cast.Heavy, type: Type1.Skill, mv: 654.10, energy: 6.61, concerto: 10.00, forte1: -4 });

// --- liberation: Radiance of Fealty — grants 4 Enflamement outright and opens Fiery Feather
export const Liberation = changliAction("Liberation - Radiance of Fealty", { node: Node.Liberation, cast: Cast.Liberation, type: Type1.Liberation, mv: 1212.75, concerto: 20, forte1: 4 });

// --- intro / outro. Intro also opens True Sight.
export const Intro = changliAction("Intro - Obedience of Rules", { node: Node.Intro, cast: Cast.Intro, type: Type1.Intro, mv: 148.34, energy: 10, concerto: 10 });
...
export const CH_LOADOUT = new Loadout(
  CHANGLI,
  CHANGLI_TALENTS,
  CH_INHERENT_1,
  CH_INHERENT_2,
