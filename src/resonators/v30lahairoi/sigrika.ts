...
import {
  ...
  Scaling, applyCurrent, applyTeam, isHeld, stacksOfTeam, removeStack, revokeSelf, casting, currentAction, addStat,
...
const Outro = sigrikaAction("Outro - In This Very Moment", { cast: Cast.Outro, type: Type1.Outro, mv: 795, active: false });
