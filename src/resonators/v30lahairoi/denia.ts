...
import { FUSION_BURST } from "../../engine/status.js";
import { ENEMY_MAX_OFFTUNE, TUNE_STRAIN_SHIFTING } from "../../engine/tunebreak.js";
import { applyStrain, TUNE_STRAIN_INTERFERED, tuneStrainBonus } from "../../engine/tunebreak.js";
...
const TO_BREAKDOWN = {
  updateBuffs: () => { revokeSelf(ENTROPY_STAGECRAFT); applyCurrent(ENTROPY_BREAKDOWN); applyCurrent(DARK_CORE, 1); },
};
