...
// Windqueller's two forms — out of Qingloong Mode it consumes 30 Resolve for +20% DMG, inside
// it's the same +20% for free (both bonuses live on JIYAN's own apply below)
...
// Intro (+15 Resolve) plus three Lone Lance hits bank exactly the 30 Finale spends; Prelude opens
// Qingloong Mode, two full lance combos bracket the free in-mode Windqueller, Banner of Triumph
// rides its mid-air window. He's never the team's own lead, so this covers both opener and loop.
