...
const BA1 = changliAction("Basic - Blazing Enlightenment 1", { frames: 27, cancel: 21, cutscene: true, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 58.98, offtune: 2792, energy: 0.88, concerto: 1.76 });
const BA2 = changliAction("Basic - Blazing Enlightenment 2", { frames: 32, cancel: 21, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 70.98, offtune: 3360, energy: 1.06, concerto: 2.10 });
const BA3 = changliAction("Basic - Blazing Enlightenment 3", { frames: 39, cancel: 29, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 109.35, offtune: 5178, energy: 1.62, concerto: 3.24 });
const BA4 = changliAction("Basic - Blazing Enlightenment 4", { frames: 68, cancel: 44, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 169.02, offtune: 8000, energy: 2.51, concerto: 5.02 });
const DC = changliAction("Dodge Counter - Blazing Enlightenment 3", { frames: 39, cancel: 29, node: Node.Normal, cast: Cast.DodgeCounter, type: Type1.Basic, mv: 247.92, offtune: 9978, energy: 3.12, concerto: 16.24 });
const HA = changliAction("Heavy - Blazing Enlightenment", { frames: 47, cancel: 35, node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 124.24, offtune: 5880, energy: 1.85, concerto: 3.69 });

// --- mid-air basics, mid-air heavy — the same combo, airborne. Stage 4 also opens True Sight.
const MA1 = changliAction("Mid-air - Blazing Enlightenment 1", { frames: 24, cancel: 13, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 61.35, offtune: 2904, energy: 0.91, concerto: 1.82 });
const MA2 = changliAction("Mid-air - Blazing Enlightenment 2", { frames: 39, cancel: 27, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 101.74, offtune: 4816, energy: 1.52, concerto: 3.02 });
const MA3 = changliAction("Mid-air - Blazing Enlightenment 3", { frames: 47, cancel: 35, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 132.00, offtune: 6249, energy: 1.98, concerto: 3.93 });
const MA4 = changliAction("Mid-air - Blazing Enlightenment 4", { frames: 53, cancel: 35, node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 126.75, offtune: 6000, energy: 1.89, concerto: 3.77 });
const MHA = changliAction("Heavy - Blazing Enlightenment (Mid-Air)", { frames: 54, cancel: 42, node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 123.27, offtune: 4960, energy: 1.55, concerto: 1.00 });
...
const SBA = changliAction("Basic - True Sight: Conquest", { frames: 73, cancel: 68, cutscene: true, node: Node.Skill, cast: Cast.Basic, type: Type1.Skill, mv: 294.73, offtune: 8985, energy: 4.04, concerto: 7.00, forte1: 1 });
const SMA = changliAction("Basic - True Sight: Charge", { frames: 40, cancel: 26, cutscene: true, node: Node.Skill, cast: Cast.Basic, type: Type1.Skill, mv: 181.70, offtune: 4353, energy: 2.57, concerto: 6.00, forte1: 1 });
...
const Skill = changliAction("Skill - Tripartite Flames", { frames: 89, cancel: 74, node: Node.Skill, cast: Cast.Skill, type: Type1.Skill, mv: 409.40, offtune: 12480, energy: 8.00, concerto: 14.00 });
...
const FlamingSacrifice = changliAction("Forte Heavy - Flaming Sacrifice", { frames: 76, cancel: 52, node: Node.Forte, cast: Cast.Heavy, type: Type1.Skill, mv: 654.10, offtune: 31141, energy: 6.61, concerto: 10.00, forte1: -4 });
...
const Intro = changliAction("Intro - Obedience of Rules", { frames: 53, cancel: 35, node: Node.Intro, cast: Cast.Intro, type: Type1.Intro, mv: 148.34, offtune: 5971, energy: 10, concerto: 10 });
