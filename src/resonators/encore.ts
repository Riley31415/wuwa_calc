...
export const S1 = new Gear("Encore S1", (ctx) => {
  if (ctx.action!.type === Type1.Basic) ctx.grantSelf(S1_STACKS);
});
...
/** S5 Hero Takes the Stage!: flat +35% Resonance Skill DMG Bonus. */
export const S5 = new Gear("Encore S5", (ctx) => { ctx.add(35, Type1.Skill, Stat.DmgBonus); });
...
const BA1 = encoreAction("Basic: Wooly Attack 1", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 55.66, energy: 70, concerto: 140, offtune: 3360, forte1: 3 });
const BA2 = encoreAction("Basic: Wooly Attack 2", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 66.20, energy: 83, concerto: 166, offtune: 3996, forte1: 5 });
const BA3 = encoreAction("Basic: Wooly Attack 3", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 132.60, energy: 166, concerto: 332, offtune: 8004, forte1: 6 });
const BA4 = encoreAction("Basic: Wooly Attack 4", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 153.08, energy: 192, concerto: 384, offtune: 9240, forte1: 4 });
const WoolyStrike = encoreAction("Basic: Wooly Strike", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 238.57, energy: 300, concerto: 600, offtune: 14400, forte1: 25 });
const HA = encoreAction("Heavy: Wooly Attack", { node: Node.Normal, cast: Cast.Heavy, type: Type1.Heavy, mv: 187.08, energy: 235, concerto: 470, offtune: 11292, forte1: 5 });
const MA = encoreAction("Basic: Wooly Attack (Mid-Air)", { node: Node.Normal, cast: Cast.Basic, type: Type1.Basic, mv: 123.26, energy: 51, concerto: 100, offtune: 14400, forte1: 11 });
const DC = encoreAction("Basic: Wooly Attack (Dodge Counter)", { node: Node.Normal, cast: Cast.DodgeCounter, type: Type1.Basic, mv: 251.88, energy: 316, concerto: 332, offtune: 8004, forte1: 6 });
...
const Skill1 = encoreAction("Skill: Flaming Woolies", {
  node: Node.Skill, cast: Cast.Skill, type: Type1.Skill, mv: 612.88, energy: 1528, concerto: 1500, offtune: 25600, forte1: 32,
  priority: PRIORITY.BUFF_STATS, apply(ctx) { ctx.grantSelf(WOOLIES_CHEER_DANCE); },
});
const EnergeticWelcome = encoreAction("Skill: Energetic Welcome", { node: Node.Skill, cast: Cast.Skill, type: Type1.Skill, mv: 339.16, energy: 75, concerto: 500, offtune: 9072, forte1: 30 });

// --- forte circuit: Cloudy Frenzy (Threshold), spends the full Mayhem gauge
const CloudyFrenzy = encoreAction("Heavy: Cloudy Frenzy", {
  node: Node.Forte, cast: Cast.Heavy, type: Type1.Liberation, mv: 773.73, concerto: 1000, offtune: 41103, forte1: -100,
});
...
//     type their Threshold-state counterparts are.
const CosmosFrolicking1 = encoreAction("Basic: Cosmos - Frolicking 1", { node: Node.Liberation, cast: Cast.Basic, type: Type1.Basic, mv: 180.36, energy: 132, concerto: 266, offtune: 6396, forte1: 8 });
const CosmosFrolicking2 = encoreAction("Basic: Cosmos - Frolicking 2", { node: Node.Liberation, cast: Cast.Basic, type: Type1.Basic, mv: 169.20, energy: 123, concerto: 249, offtune: 6000, forte1: 12 });
const CosmosFrolicking3 = encoreAction("Basic: Cosmos - Frolicking 3", { node: Node.Liberation, cast: Cast.Basic, type: Type1.Basic, mv: 263.96, energy: 192, concerto: 388, offtune: 9360, forte1: 16 });
const CosmosFrolicking4 = encoreAction("Basic: Cosmos - Frolicking 4", { node: Node.Liberation, cast: Cast.Basic, type: Type1.Basic, mv: 582.03, energy: 429, concerto: 858, offtune: 20640, forte1: 27 });
...
const CosmosHeavy = encoreAction("Heavy: Cosmos - Heavy Attack", { node: Node.Liberation, cast: Cast.Heavy, type: Type1.Heavy, mv: 217.58, energy: 160, concerto: 321, offtune: 7716, forte1: 9 });
const CosmosRampage = encoreAction("Skill: Cosmos - Rampage", {
  node: Node.Liberation, cast: Cast.Skill, type: Type1.Skill, mv: 253.28, energy: 656, concerto: 800, offtune: 6168, forte1: 28,
  priority: PRIORITY.BUFF_STATS, apply(ctx) { ctx.grantSelf(WOOLIES_CHEER_DANCE); },
});
const CosmosDodgeCounter = encoreAction("Basic: Cosmos - Dodge Counter", { node: Node.Liberation, cast: Cast.DodgeCounter, type: Type1.Basic, mv: 263.96, energy: 344, concerto: 388, offtune: 9360, forte1: 16 });
...
const Intro = encoreAction("Intro: Woolies Helpers", {
  node: Node.Intro, cast: Cast.Intro, type: Type1.Intro, mv: 198.81, energy: 1000, concerto: 1000, offtune: 15132, forte1: 40,
});
...
const Outro = encoreAction("Outro: Thermal Field", {
  cast: Cast.Outro, type: Type1.Outro, mv: 707.04, concerto: -10000, active: false,
});
