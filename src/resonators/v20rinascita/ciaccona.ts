...
import {
  ...
  Cast, Node, Scaling, applyCurrent, applyTeam, applyEnemy, revokeTeam, isHeld, revokeSelf, casting, currentAction,
  addStat, queue, Type2,
} from "../../engine/kit.js";
import { Rotation, OPENER, INTRO, ECHO_CAST, OUTRO_NEXT } from "../../engine/rotation.js";
import { AERO_EROSION, SHIELD } from "../../engine/status.js";
