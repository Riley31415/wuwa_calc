...
var tuneRuptureResponse = (action) => {
  if (currentAction() === TUNE_BREAK && applied2(TUNE_RUPTURE_INTERFERED))
    queue(action);
};
var tuneHackResponse = (action) => {
  if (currentAction() === TUNE_BREAK && applied2(TUNE_HACK_INTERFERED))
    queue(action);
};
  ...
  const BAMBOO_CLEAVER = new Buff({
    ...
    applyStats: () => {
      if (frozenStacks() >= 2)
        addStat(
          17,
          [30, 37.5, 45, 52.5, 60][r] * (frozenStacks() - 1),
          8192
          /* Type1.Heavy */
        );
    }
  ...
  return new Weapon({
    ...
    grants: [
      { on: onCast(
        6
        /* Cast.Intro */
      ), buff: HEART_SETTLES_TEAM, to: "team" },
      { on: () => (casting(
        6
        /* Cast.Intro */
      ) || casting(
        ...
        2
        /* Cast.MidAir */
      )) && !stacksOf(BAMBOO_CLEAVER), buff: BAMBOO_CLEAVER }
    ]
  });
});
...
var STATIC_MIST = refinements((r, rank) => {
  ...
  return new Weapon({
    ...
    grants: [{ on: onCast(
      7
      /* Cast.Outro */
    ), buff: STATIC_MIST_HANDOFF, to: "next" }]
  });
});
...
var EMPYREAN_ANTHEM_5PC = new Sonata({
  ...
  grants: [{ on: onType(
    262144
    /* Type2.Coordinated */
  ), buff: () => EMPYREAN_ANTHEM_TEAM, to: "team" }]
});
  ...
  return new Weapon({
    ...
    grants: [
      ...
      { on: both(onCast(
        ...
        2
        /* Cast.MidAir */
      ), onInflict(TUNE_RUPTURE_SHIFTING, TUNE_STRAIN_SHIFTING)), buff: SPECTRUM_CHORUS, to: "team" }
    ]
  });
});
...
var LAW_OF_HARMONY_3PC = new Sonata3pc({
  ...
  grants: [
    ...
    { on: onCast(
      8
      /* Cast.Echo */
    ), buff: LAW_OF_HARMONY_TEAM, to: "team" }
  ]
});
...
var ELECTRIC_REFLECTION_BUFF = new Buff({
  ...
  grants: [{ on: onCast(
    7
    /* Cast.Outro */
  ), buff: () => ELECTRIC_REFLECTION_HANDOFF, to: "next" }]
});
...
var TINGED_YEARNING_2PC = new Sonata2pc({ name: "Flower of Tinged Yearning 2pc", stats: [[23, 10]] });
...
var ROVER_AERO_RESONATOR = new Resonator({
  ...
  updateBuffs: () => {
    ...
    if ((a === UnboundFlow1 || a === UnboundFlow2) && rank >= 0)
...
var NEONLIGHT_LEAP_5PC = new Sonata({
  ...
  grants: [{ on: onCast(
    7
    /* Cast.Outro */
  ), buff: () => NEONLIGHT_LEAP_HANDOFF, to: "next" }]
});
...
var STARRY_RADIANCE_2PC = new Sonata2pc({ name: "Halo of Starry Radiance 2pc", stats: [[23, 10]] });
...
var CHROMATIC_FOAM_BUFF = new Buff({
  ...
  grants: [{ on: onCast(
    7
    /* Cast.Outro */
  ), buff: () => CHROMATIC_FOAM_HANDOFF, to: "next" }]
});
...
var REEL_TEAM = new Buff({ name: "Reel of Spliced Memories", stats: [[12, 20]] });
  ...
  return new Weapon({
    ...
    grants: [
      ...
      { on: both(onCast(
        4
        /* Cast.Skill */
      ), onApplied(HEALS)), buff: SK_SIG_TEAM, to: "team" }
    ]
  });
});
...
var RB_INHERENT_1 = new Inherent({
  ...
  updateBuffs: () => {
    const a = currentAction();
    if (applied2(A_GIRL) || a === FHAHunt || a === FHAGuts)
...
var BA114 = roverAction2("Basic - Deterrence 1", { node: 0, cutscene: true, cast: 1, type: 4096, mv: 51.08, energy: 0.92, concerto: 3.31, offtune: 2936, forte1: 6.12 });
...
var BA416 = deniaAction("Basic - Stagecraft Form 4", { cutscene: true, node: 0, cast: 1, type: 4096, mv: 128, energy: 0.69, concerto: 5.37, offtune: 8584, forte1: 30 });
...
var Skill18 = deniaAction("Skill - Phantom Bubble", { cutscene: true, node: 1, cast: 4, type: 12288, mv: 104.51, energy: 0.22, concerto: 24.4, offtune: 7008, forte1: 25 });
var Beckon = deniaAction("Skill - Beckon", { cutscene: true, node: 1, cast: 4, type: 12288, mv: 103.7, energy: 2.21, concerto: 4.36, offtune: 6956, forte2: 13 });
var Banish1 = deniaAction("Skill - Banish 1", { cutscene: true, node: 1, cast: 4, type: 12288, mv: 104.04, energy: 2.19, concerto: 4.38, offtune: 6978 });
var Banish2 = deniaAction("Skill - Banish 2", { cutscene: true, node: 1, cast: 4, type: 16384, mv: 112.01, energy: 2.35, concerto: 14.7, offtune: 7512, forte2: 40 });
...
var INTERFERED_MARKER = new Debuff({
  ...
  applyStats: () => {
    ...
    if (her?.isHeld(MO_S1) || stacksOfEnemy(TUNE_RUPTURE_INTERFERED) > 0 || stacksOfEnemy(TUNE_STRAIN_INTERFERED) > 0)
      addStat(17, 40);
    if (her?.isHeld(MO_S2))
      addStat(10, 32);
  }
...
var BA1237 = new ActionGroup("Basic - Impromptu Show 123", [BA127, BA226, BA327]);
...
var BA1238 = new ActionGroup("Basic - Present Self 123", [BA129, BA228, BA328]);
...
var LC_S42 = new Sequence({
  ...
  updateBuffs: () => {
    const a = currentAction();
    if (a === OblivionEcho || a === OblivionChafe)
...
var BA1239 = new ActionGroup("Basic - Zephyr Stance 123", [BA132, BA231, BA331]);
...
var BA12310 = new ActionGroup("Basic - Dimming Brush 123", [BA133, BA233, BA332]);
...
var ZZ_S3 = new Sequence({
  ...
  updateBuffs: () => {
    const a = currentAction();
    if (a === Skill31 || a === FSkill9 || a === FSkill33)
...
var ZZ_S5 = new Sequence({
  ...
  updateBuffs: () => {
    if (currentAction() === ACTION_INKLIT && stacksOfTeam(INKLIT_SPIRITS) % 3 === 0)
...
var FEATHERED_OATH = new Buff({
  ...
  updateBuffs: () => {
    if (currentAction() === HiB3 && !applied2(HAVOC_BANE))
...
var Liberation32 = jinhsiAction("Liberation - Purge of Light", {
  node: 3,
  cast: 5,
  cutscene: true,
  type: 16384,
...
var LK_INHERENT_2 = new Inherent({
  ...
  updateGlobal: () => {
    const a = currentAction();
    if (applied2(TUNE_STRAIN_SHIFTING) || a === TUNE_BREAK)
...
var BA12311 = new ActionGroup("Basic - Origin Calculus 123", [BA144, BA246, BA347]);
